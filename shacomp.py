...
parser.add_argument( '-N', '--newest-first', dest='forder',
                    ...
                    default='oldest',
                    help='Assume given digests provided in order from newest to ' +
                    'oldest. (Default is oldest-to-newest)' )
...
parser.add_argument( '-F', '--no-first-file-changes', action='store_false',
                    dest='first',
                    help="Don't display change column for first digest file" )
parser.add_argument( '-u', '--show-unchanged', action='store_true',
                    help="Include files that were unchanged across all digests" )
parser.add_argument( '-c', '--activity-chars', default='|+-#',
                    help='Characters to display for files that are unchanged, ' +
                    'added, removed, or modified. (Default "|+-#")' )
